...
import ManageLoyalties from "./pages/admin/bonuses/ManageLoyalties";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/user/network"
          element={<MainLayout pageName={"Networks"} child={<Network />} />}
        />
        <Route
          path="/user/transactions"
          element={
            <MainLayout pageName={"Transactions"} child={<Transactions />} />
          }
        />
        <Route
          path="/user/deposit"
          element={<MainLayout pageName={"Deposit"} child={<Deposit />} />}
        />
        <Route
          path="/user/withdraw"
          element={<MainLayout pageName={"Withdraw"} child={<Withdraw />} />}
        />
        <Route
          path="/user/transfer"
          element={<MainLayout pageName={"Transfer"} child={<Transfer />} />}
        />
        <Route
          path="/user/recharge"
        ...
        <Route
          ...
          element={
            <MainLayout
              ...
              child={<RechargeHistory />}
            />
          }
        />
        <Route
          path="/user/profile"
          element={<MainLayout pageName={"Profile"} child={<Profile />} />}
        />
        <Route
          path="/user/upgrade"
          element={
        ...
        <Route
          ...
          element={
            <MainLayout
              pageName={"Manage Announcement"}
              child={<ManageAnnouncement />}
            />
          }
        />
        <Route
          ...
          element={
            <MainLayout
              pageName={"Create Testimonials"}
              child={<ManageTestimonials />}
            />
          }
        />
        <Route
