    ...
    return (
        <div>
            ...
            {selectedOrder && (
                ...
                >
                    <h3 className="font-bold text-center md:text-xl">Ref ID: #{selectedOrder.ref_no}</h3>
                    ...
                    <div className={`w-full py-2 mt-4 ${selectedOrder?.orders?.delivery === "picked" ? "bg-[#dff7ee]/80 text-pryclr" : selectedOrder?.orders?.delivery === "failed" ? "bg-[#c51236]/20 text-red-600" : "bg-yellow-100 text-yellow-600"} rounded-lg text-center font-normal mx-auto border border-pryClr/15`}>
                        Status: {selectedOrder?.orders?.delivery === "picked" ? "Picked" : selectedOrder?.orders?.delivery === "failed" ? "Failed" : "Pending"}
                    </div>
                </Modal>
            )}
        </div>
