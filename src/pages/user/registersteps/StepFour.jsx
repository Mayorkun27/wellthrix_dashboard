      ...
      <div className='w-full flex flex-col gap-4 md:gap-6 rounded-2xl bg-white shadow-md px-4 md:px-6 py-6'>
        ...
        <div className='w-full rounded-xl bg-pryClr/5 border border-black/20 shadow-md px-4 md:px-6 py-6 grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6'>
          <div className='flex flex-col'>
            ...
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_2.first_name || 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>Last Name</p>
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_2.last_name || 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>Gender</p>
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_2.gender ? registerOverview?.step_2.gender.charAt(0).toUpperCase() + registerOverview?.step_2.gender.slice(1) : 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>Country</p>
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_2.country || 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>State</p>
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_2.state || 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>City</p>
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_2.city || 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>Mobile</p>
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_2.mobile || 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>Email</p>
            <p className="text-lg md:text-xl font-bold break-all">{registerOverview?.step_2.email || 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>Date of Birth</p>
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_2.date_of_birth || 'N/A'}</p>
          </div>
        </div>
        ...
        <div className='w-full rounded-xl bg-pryClr/5 border border-black/20 shadow-md px-4 md:px-6 py-6 grid grid-cols-2 gap-4 md:gap-6'>
          <div className='flex flex-col'>
            ...
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_3.username || 'N/A'}</p>
          </div>
          <div className='flex flex-col'>
            <p className='text-sm md:text-lg text-black/70'>Password</p>
            <p className='text-lg md:text-xl font-bold'>{registerOverview?.step_3.password || 'N/A'}</p>
          </div>
        </div>
