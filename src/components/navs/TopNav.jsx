...
const optionsTransactions = ['E-Wallet', 'Purchase Wallet', 'Withdraw History', 'Product History'];
// 'Earnings Wallet', 'Incentive Wallet', 
    ...
    <div className='w-full'>
      <div className="w-full flex gap-3 items-center justify-between">
        ...
        <div className="flex items-center md:gap-5 gap-3">
          ...
          <Link
            to="/user/profile"
            className="md:w-11 w-10 md:h-11 h-10 rounded-full border border-pryClr bg-white overflow-hidden uppercase flex items-center justify-center"
          >
