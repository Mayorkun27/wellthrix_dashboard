        ...
        <>
                    ...
                    isLoading ? (
                        ...
                        announcements.map((announcement, index) => (
                            <AnnouncementList
                                ...
                                {...announcement}
                                action={() => {
                                    setSelectedAnnouncementAttachment(announcement);
            ...
            {selectedAnnouncementAttachment && (
                <Modal onClose={() => setSelectedAnnouncementAttachment(null)}>
                    ...
                    <div
                        className="underline mt-3 text-center mx-auto cursor-pointer"
                        onClick={() => {
                            setSelectedAnnouncement(selectedAnnouncementAttachment)
